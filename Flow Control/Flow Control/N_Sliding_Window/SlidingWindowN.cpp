...
//############################################################################################################################
	...
	for(int i=0;i<64;i++)//===============================================================CHANGED HERE
		cout<<msg[i]<<((i!=63)?" ":"\n");	
			...
			*/
			...
			else if(numFds > 0)
			{
				...
				*/
				if(receivedBuff[0]=='A') 
				{
					if( (token+1)%3 == atoi(&receivedBuff[3]) )
					{
//						seek -= 16;
					...
					else if( (token+2)%3 == atoi(&receivedBuff[3]) )
					{
						seek += 16;
				...
				*/
				...
				{
				/*	if( (token+1)%3 == atoi(&receivedBuff[4]) )
					{
						seek -= 16;
						
						next = true;
					}
					else if( (token+2)%3 == atoi(&receivedBuff[4]) )
					{
						token = (token+1)%3;
					...
					if( token == atoi(&receivedBuff[4]) )
					{
						seek -= 16;
						
						next = true;
					}
					else if( (token+1)%3 == atoi(&receivedBuff[4]) )
					{
						token = (token+1)%3;
