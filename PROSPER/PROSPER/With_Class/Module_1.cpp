...
int Module_1::binarySearch(int *a, int item, int low, int high)
{
	if (high <= low)
	{
		if(item > a[low])
...
void Module_1::binary_Insertion_Sort(int *array , int first , int last)
{
...
void Module_1::Insertion_Sort_Iteration(int *array , int first , int last)
{
int key=0,i=0;
...
void Module_1::countInversions(int *array,int size)
{
...
void Module_1::print(int *array , int size)
{
...
void Module_1::Insertion_Sort_Recursion(int *array , int first , int start , int tsize) 
{
    if (first < tsize)
    {
        int j;
