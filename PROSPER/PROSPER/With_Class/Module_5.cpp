...
void Module_5::Plot_Insertion_sort()
{
...
//			cout<<a1[i]<<"\t";
		...
		clock_t Start = clock();
		M1.Insertion_Sort_Iteration( a1 , 0 , size-1);
		...
		Start = clock();
		M1.Insertion_Sort_Recursion( a2 , 0 , 0 , size);
...
//		FILE *fptr;
		...
		Start = clock();
		M1.binary_Insertion_Sort( a3 , 0 , size-1);
		time = ((clock() - Start) / double(CLOCKS_PER_SEC))*1000;
...
//		srand(time(NULL));
		...
		clock_t Start = clock();
		M2.Quicksort_Classic( a1 , 0 , size-1);
		double time = ((clock() - Start) / double(CLOCKS_PER_SEC))*1000;
		...
		Start = clock();
		M2.Quicksort_First( a2 , 0 , size-1);
		time = ((clock() - Start) / double(CLOCKS_PER_SEC))*1000;
...
//		FILE *fptr;
		...
		Start = clock();
		M2.Quicksort_Middle( a3 , 0 , size-1);
		time = ((clock() - Start) / double(CLOCKS_PER_SEC))*1000;
...
//		srand(time(NULL));
		Start = clock();
		M2.Quicksort_Random( a4 , 0 , size-1);
		time = ((clock() - Start) / double(CLOCKS_PER_SEC))*1000;
...
void Module_5::Plot_Hybrid_Sort()
{
...
//		srand(time(NULL));
		...
		Start = clock();
		M2.Quicksort_Classic( a2 , 0 , size-1);
		time = ((clock() - Start) / double(CLOCKS_PER_SEC))*1000;
...
//		FILE *fptr;
		...
		Start = clock();
		M3.Quicksort_Hybrid( a3 , 0 , size-1);
		time = ((clock() - Start) / double(CLOCKS_PER_SEC))*1000;
...
//		FILE *fptr;
		...
		Start = clock();
		M3.Mergesort_Hybrid( a4 , 0 , size-1);
		time = ((clock() - Start) / double(CLOCKS_PER_SEC))*1000;
...
void Module_5::Plot_Variant_Linear()
{
...
//		srand(time(NULL));
		...
		clock_t Start = clock();
		M3.Variant_Linear_Search( a1 , size , rand() % 500 + 1);
		double time = ((clock() - Start) / double(CLOCKS_PER_SEC))*1000;
		...
		Start = clock();
		M3.Linear_Search( a2 , size , rand() % 500 + 1);
		time = ((clock() - Start) / double(CLOCKS_PER_SEC))*1000;
